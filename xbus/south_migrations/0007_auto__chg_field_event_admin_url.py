...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.admin_url'
        db.alter_column(u'xbus_event', 'admin_url', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Event.admin_url'
        db.alter_column(u'xbus_event', 'admin_url', self.gf('django.db.models.fields.CharField')(max_length=250))
